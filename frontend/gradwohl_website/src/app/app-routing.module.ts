...
const routes: Routes = [
  ...
  canActivate: [MasterGuardService], data: {guards: [AuthGuardService], roles: ['Zentrale', 'Leiter', 'Verkauf']}},
  {path: 'warenbestellungEingabe/:datum/:id', component: WarenbestellungEingabeComponent,
  canActivate: [MasterGuardService], data: {guards: [AuthGuardService], roles: ['Zentrale', 'Leiter', 'Verkauf']}},
  {path: 'vorlagenView', component: VorlagenViewComponent,
  canActivate: [MasterGuardService], data: {guards: [AuthGuardService], roles: ['Leiter', 'Verkauf']}},
